        ...
        <div class="card login-frm-bg mb-3">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('verification.send') }}" method="POST">
                    ...
                    <div class="text-center mb-3">
                        <button type="submit" class="btn btn-outline-light btn-lg px-5 m-3">{{ __('Resend Verification Link') }}</button>
                    </div>
                </form>
            ...
            <div class="card-footer text-center">
                ...
                <form action="{{ route('logout') }}" method="POST">
                    @csrf
                    <button type="submit" class="btn btn-outline-light btn-lg px-5 m-3">{{ __('Return to main page') }}</button>
                </form>
