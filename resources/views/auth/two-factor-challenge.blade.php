            ...
            <div class="card-body">
                ...
                <form action="{{ route('two-factor.login') }}" method="POST">
                    ...
                    <div class="my-3">
                        ...
                        <input type="text" class="form-control form-control-lg" id="inputCode" name="code" placeholder="{{ __('Enter authentication code') }}" required>
                    </div>
            ...
            <div class="card-body">
                ...
                <form action="{{ route('two-factor.login') }}" method="POST">
                    ...
                    <div class="my-3">
                        ...
                        <input type="text" class="form-control form-control-lg" id="inputRecoveryCode" name="recovery_code" placeholder="{{ __('Enter recovery code') }}" required>
                    </div>
                    <div class="text-center">
                        <button type="submit" class="btn btn-outline-light btn-lg px-5 m-3">{{ __('Submit') }}</button>
                    </div>
                ...
                <form action="{{ route('two-factor-recovery-codes.send') }}" method="POST">
                    @csrf
                    <div class="text-center">
                        <button type="submit" class="btn btn-outline-light btn-lg px-5 m-3">{{ __('Email recovery codes') }}</button>
                    </div>
                </form>
