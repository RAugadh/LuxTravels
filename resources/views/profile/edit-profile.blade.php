        ...
        <div class="col-lg-5">
            <div class="card mb-3">
                    ...
                    <form action="{{ route('user-profile-information.update') }}" method="POST">
                        ...
                        <div class="my-3">
                            ...
                            <input type="email" class="form-control" id="inputEmail" name="email"
                                placeholder="{{ __('Enter new email address') }}" value="{{ Auth::user()->email }}"
                                required>
                        </div>
                        <div class="mb-3">
                            <label for="inputName" class="form-label">{{ __('Enter new name') }}</label>
                            <input type="text" class="form-control" id="inputName" name="name"
                                placeholder="{{ __('Enter new name') }}" value="{{ Auth::user()->name }}" required>
                        </div>
                ...
                <div class="card-footer text-center">
                    <a href="{{ url('/dashboard') }}">{{ __('Return to home page') }}</a>
                </div>
            </div>
